...
import com.uma.umalibrary.databinding.ActivityMainBinding
import com.uma.umalibrary.logic.model.SearchBean
import com.uma.umalibrary.ui.home.HomeViewModel
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        with(binding) {
            // 搜索框输入监听
            appBarMain.searchView.setOnQueryTextListener(object: SimpleSearchView.OnQueryTextListener{
